  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col">
        {/* Header */}
        <div className="flex items-start justify-between p-6 pb-4 border-b border-gray-200 shrink-0">
          <div className="flex items-start gap-3 flex-1">
            <div className="w-10 h-10 bg-blue-50 rounded-lg flex items-center justify-center shrink-0">
              <RiBookMarkedLine className="w-6 h-6 text-[var(--color-primary)]" />
            </div>
            <div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div>
            <h3 className="font-semibold text-[var(--color-black)] mb-3">
              Modalidad de Inscripción
            </h3>
        ...
        <div className="p-6 pt-4 border-t border-gray-200 shrink-0">
          <button
            ...
            className="w-full py-3 bg-[var(--color-primary)] text-white font-medium rounded-lg
