...
function StudentLoginForm() {
  ...
  return (
    <div className="min-h-screen from-primary/10 to-tertiary flex items-center justify-center p-2 sm:p-4 lg:pb-2">
      <div className="w-full max-w-2xl mx-auto">
        {/* Header */}
        <div className="bg-foreground text-primary rounded-t-2xl px-4 sm:px-6 lg:px-8 py-4 sm:py-6 flex items-center gap-3 sm:gap-4">
          <div className="bg-primary/20 p-2 sm:p-3 rounded-lg backdrop-blur-sm flex-shrink-0">
        ...
        <div className="bg-white rounded-b-2xl shadow-2xl">
          <div className="bg-primary px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="bg-white text-primary w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center font-bold text-sm sm:text-base flex-shrink-0">
                i
              </div>
          ...
          <form onSubmit={handleSubmit} className="p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
              <div className="flex items-center gap-2 sm:gap-3 sm:w-48">
                ...
                <label className="font-semibold text-black text-sm sm:text-base">Contraseña</label>
              </div>
              <div className="flex-1 w-full">
                <input
                  type="password"
                ...
                />
                {errors.contrasena && (
                  <p className="text-red text-xs sm:text-sm mt-1">{errors.contrasena}</p>
                )}
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
              <div className="flex items-center gap-2 sm:gap-3 sm:w-48 sm:pt-3">
                <div className="bg-primary/10 p-2 sm:p-3 rounded-lg flex-shrink-0">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-primary" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                  </svg>
                </div>
                <label className="font-semibold text-black text-sm sm:text-base">Fecha de Nacimiento</label>
              </div>
            ...
            <div className="bg-background rounded-lg p-3 sm:p-4">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                <div className="flex items-center gap-2 sm:gap-3 sm:w-44">
                  <div className="bg-primary/10 p-2 sm:p-3 rounded-lg flex-shrink-0">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-primary" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                  </div>
                  <label className="font-semibold text-black text-sm sm:text-base">Código</label>
                </div>
                <div className="flex-1 w-full">
                  <input
                    type="text"
                  ...
                  />
                  {errors.codigo && (
                    <p className="text-red text-xs sm:text-sm mt-1">{errors.codigo}</p>
                  )}
                </div>
              </div>
            </div>
